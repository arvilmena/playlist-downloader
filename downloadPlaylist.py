...
YOUTUBE_DL_COMMAND = "/usr/local/bin/youtube-dl --verbose -i --download-archive downloaded.txt --no-post-overwrites -c -o '%(playlist_uploader)s-%(playlist_title)s/%(upload_date)s-%(title)s--id=%(id)s.%(ext)s' --restrict-filenames -f 22/18"
